...
function CreateWatchListing() {
    ...
    return (
        <div className={styles.createWatchListing}>
            ...
            <input type="file" onChange={(e) => {setImageUpload(e.target.files[0])}} className={styles.input}/>
            <input placeholder="Watch Name..." type="text" onChange={e => {
                setWatchName(e.target.value)
            }} className={styles.input}/>
            <input type="number" placeholder="Price..."onChange={e => {setWatchPrice(e.target.value)}} className={styles.input}/>
